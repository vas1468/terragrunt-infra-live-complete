# terragrunt-infra-live-complete

This repo, along with the [terragrunt-infra-modules-complete 
repo](https://github.com/vas1468/terragrunt-infra-modules-complete), show an example file/folder structure
...
This repo shows an example of how to use the modules from the `terragrunt-infra-modules-complete` repo to 
deploy modules across three environments (dev, stage, prod) and two AWS accounts 
